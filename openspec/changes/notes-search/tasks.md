...
- [ ] **Update Project schema and type**: Modify `src/domain/entities/Project.ts`
...
- [ ] **Update Engram schema and type**: Modify `src/domain/entities/Engram.ts`
...
- [ ] **Create text normalization utility**: Implement `normalizeText` in `src/lib/search.ts`
  - Must strip diacritics / accents using `.normalize("NFD").replace(/[\u0300-\u036f]/g, "")`.
  - Must convert text to lowercase and trim it.

## 2. UI Components

- [ ] **Implement `SearchInput.tsx`**: Create `src/components/ui/SearchInput.tsx`
...
- [ ] **Implement `TagCloud.tsx`**: Create `src/components/ui/TagCloud.tsx`
...
- [ ] **Implement `SearchableGrid.tsx`**: Create `src/components/ui/SearchableGrid.tsx`
...
- [ ] **Integrate `SearchableGrid` in Notes Index**: Modify `src/app/[locale]/notes/page.tsx`
...
- [ ] **Integrate `SearchableGrid` in Projects Index**: Modify `src/app/[locale]/projects/page.tsx`
  - Replace the static mapping grid with the `SearchableGrid` client component.
...
- [ ] **Add metadata to test notes and projects**:
